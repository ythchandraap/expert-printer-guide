...
!(function (t, e) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    : e(
        ((t =
          "undefined" != typeof globalThis ? globalThis : t || self).tabler =
          {})
      );
})(this, function (t) {
  "use strict";
  ...
  function V(t) {
    return "html" === x(t)
      ? t
      : t.assignedSlot || t.parentNode || ($(t) ? t.host : null) || R(t);
  }
  function K(t) {
    return L(t) && "fixed" !== W(t).position ? t.offsetParent : null;
  }
  function U(t) {
    for (var e = k(t), i = K(t); i && q(i) && "static" === W(i).position; )
      i = K(i);
    return i &&
      ...
      : i ||
          (function (t) {
            ...
            if (/Trident/i.test(j()) && L(t) && "fixed" === W(t).position)
              return null;
            var i = V(t);
            for (
              $(i) && (i = i.host);
              L(i) && ["html", "body"].indexOf(x(i)) < 0;
    ...
    if (p) {
      ...
      x === k(i) &&
        ...
        (l !== r && ((l !== n && l !== s) || c !== h)) ||
          ((T = o),
          (b -=
            (g && x === O && O.visualViewport ? O.visualViewport.width : x[L]) -
            a.width),
          (b *= f ? 1 : -1));
    }
    var $,
      D = Object.assign({ position: d }, p && tt),
      I =
        !0 === m
          ? (function (t, e) {
              var i = t.x,
  ...
  function _t(t, e) {
    ...
    var i = e,
      ...
      })(S($) ? $ : $.contextElement || R(t.elements.popper), g, b, h),
      I = H(t.elements.reference),
      M = gt({ reference: I, element: k, placement: a }),
  ...
  const vt = {
    ...
    fn: function (t) {
      ...
      if (!e.modifiersData[l]._skip) {
        ...
        e.placement !== L &&
          ((e.modifiersData[l]._skip = !0), (e.placement = L), (e.reset = !0));
      }
    },
        ...
        if (x) {
            ...
            var j,
              ...
              at = rt
                ? "y" === C
                  ...
                  : rt.clientLeft || 0
                : 0,
              lt = null != (j = null == D ? void 0 : D[C]) ? j : 0,
              ct = W + ot - lt,
          ...
          if (d) {
            var ut,
              ...
              bt = pt - w[ft],
              vt = -1 !== [n, r].indexOf(A),
              yt = null != (ut = null == D ? void 0 : D[O]) ? ut : 0,
              wt = vt ? gt : pt - k[mt] - S[mt] - yt + $.altAxis,
              At = vt ? pt + k[mt] + S[mt] - yt - $.altAxis : bt,
              Et =
                b && vt
                  ? (function (t, e, i) {
                      var n = X(t, e, i);
  ...
  var $t = Lt(),
    Dt = Lt({ defaultModifiers: [st, Tt, it, D] }),
  ...
  const Pt = Object.freeze(
    ...
    Jt = (t, e, i = !0) => {
      ...
      let s = !1;
      const o = ({ target: i }) => {
        i === e && ((s = !0), e.removeEventListener(jt, o), Gt(t));
      };
  ...
  function fe(t, e, i, n) {
    ...
    for (const [o, r] of Object.entries(s))
      o.includes(n) && de(t, e, i, r.callable, r.delegationSelector);
  }
  function pe(t) {
  ...
  const me = {
    ...
    off(t, e, i, n) {
      ...
      const [s, o, r] = he(e, i, n),
        ...
        h = e.startsWith(".");
      if (void 0 === o) {
        if (h) for (const i of Object.keys(l)) fe(t, l, i, e.slice(1));
        for (const [i, n] of Object.entries(c)) {
          const s = i.replace(ie, "");
          (a && !e.includes(s)) ||
            de(t, l, r, n.callable, n.delegationSelector);
        }
      } else {
  ...
  const ve = {
    ...
    getDataAttributes(t) {
      ...
      for (const n of i) {
        let i = n.replace(/^bs/, "");
        (i = i.charAt(0).toLowerCase() + i.slice(1)), (e[i] = _e(t.dataset[n]));
      }
      return e;
    },
  ...
  class ye {
    ...
    _mergeConfigObj(t, e) {
      const i = zt(e) ? ve.getDataAttribute(e, "config") : {};
      return {
        ...this.constructor.Default,
        ...("object" == typeof i ? i : {}),
        ...(zt(e) ? ve.getDataAttributes(e) : {}),
        ...("object" == typeof t ? t : {}),
      };
    }
  ...
  class we extends ye {
    ...
    static getInstance(t) {
      return Mt.get(Bt(t), this.DATA_KEY);
    }
    ...
    Ee = {
      ...
      focusableChildren(t) {
        const e = [
          ...
          .join(",");
        return this.find(e, t).filter((t) => !qt(t) && Wt(t));
      },
    ...
    Te = (t, e = "hide") => {
      ...
      me.on(document, i, `[data-bs-dismiss="${n}"]`, function (i) {
        if (
          ...
          return;
        const s = Ee.getElementFromSelector(this) || this.closest(`.${n}`);
  ...
  class ke extends we {
    ...
    close() {
      if (me.trigger(this._element, Oe).defaultPrevented) return;
  ...
  me.on(document, "click.bs.button.data-api", Se, (t) => {
    t.preventDefault();
  ...
  class He extends ye {
    ...
    _initEvents() {
      this._supportPointerEvents
        ? (me.on(this._element, Ne, (t) => this._start(t)),
          me.on(this._element, Me, (t) => this._end(t)),
          this._element.classList.add("pointer-event"))
        : (me.on(this._element, De, (t) => this._start(t)),
  ...
  class hi extends we {
    ...
    _addEventListeners() {
      this._config.keyboard &&
        me.on(this._element, Ye, (t) => this._keydown(t)),
    ...
    _setActiveIndicatorElement(t) {
      ...
      const e = Ee.findOne(si, this._indicatorsElement);
    ...
    _getActive() {
      return Ee.findOne(ri, this._element);
    }
    _getItems() {
      return Ee.find(oi, this._element);
    }
    _clearInterval() {
      this._interval &&
    ...
    _directionToOrder(t) {
      return Xt() ? (t === Ke ? Ve : Re) : t === Ke ? Re : Ve;
    }
    _orderToDirection(t) {
      return Xt() ? (t === Ve ? Ke : Ue) : t === Ve ? Ue : Ke;
    }
    static jQueryInterface(t) {
      return this.each(function () {
  ...
  me.on(document, ei, "[data-bs-slide], [data-bs-slide-to]", function (t) {
    ...
    t.preventDefault();
    const i = hi.getOrCreateInstance(e),
    ...
    me.on(window, ti, () => {
      ...
      for (const e of t) hi.getOrCreateInstance(e);
    }),
    Yt(hi);
  const ui = ".bs.collapse",
    di = `show${ui}`,
    fi = `shown${ui}`,
    pi = `hide${ui}`,
    mi = `hidden${ui}`,
    gi = `click${ui}.data-api`,
    _i = "show",
    bi = "collapse",
    vi = "collapsing",
    yi = `:scope .${bi} .${bi}`,
    wi = '[data-bs-toggle="collapse"]',
    Ai = { parent: null, toggle: !0 },
  ...
  class Ti extends we {
    ...
    show() {
      ...
      if (
        ...
        return;
      if (me.trigger(this._element, di).defaultPrevented) return;
      ...
      this._queueCallback(
        () => {
          (this._isTransitioning = !1),
            ...
            this._element.classList.add(bi, _i),
    ...
    hide() {
      ...
      (this._element.style[t] = `${
        ...
        Kt(this._element),
        this._element.classList.add(vi),
        this._element.classList.remove(bi, _i);
    ...
    _getFirstLevelChildren(t) {
      const e = Ee.find(yi, this._config.parent);
  ...
  const Ci = "dropdown",
    ...
    qi = Xt() ? "bottom-end" : "bottom-start",
    Ri = Xt() ? "bottom-start" : "bottom-end",
    Vi = Xt() ? "left-start" : "right-start",
    Ki = Xt() ? "right-start" : "left-start",
    Ui = {
      autoClose: !0,
  ...
  class Xi extends we {
    constructor(t, e) {
      super(t, e),
        ...
        (this._menu =
          Ee.next(this._element, zi)[0] ||
          Ee.prev(this._element, zi)[0] ||
          Ee.findOne(zi, this._parent)),
    ...
    show() {
      ...
      if (!me.trigger(this._element, Di, t).defaultPrevented) {
        if (
          (this._createPopper(),
          "ontouchstart" in document.documentElement &&
    ...
    _completeHide(t) {
      if (!me.trigger(this._element, Li, t).defaultPrevented) {
    ...
    _getPlacement() {
      ...
      return t.classList.contains("dropup") ? (e ? Wi : Bi) : e ? Ri : qi;
    }
    _detectNavbar() {
    ...
    _selectMenuItem({ key: t, target: e }) {
      ...
      i.length && Zt(i, e, t === Si, !i.includes(e)).focus();
    }
    static jQueryInterface(t) {
      return this.each(function () {
    ...
    static dataApiKeydownHandler(t) {
      ...
      const s = this.matches(Fi)
          ...
          : Ee.prev(this, Fi)[0] ||
            Ee.next(this, Fi)[0] ||
            Ee.findOne(Fi, t.delegateTarget.parentNode),
  ...
  me.on(document, Ni, Fi, Xi.dataApiKeydownHandler),
    ...
    me.on(document, Pi, Xi.clearMenus),
    me.on(document, Mi, Xi.clearMenus),
    me.on(document, Pi, Fi, function (t) {
  ...
  class cn extends ye {
    ...
    _handleFocusin(t) {
      ...
      if (t.target === document || t.target === e || e.contains(t.target))
        return;
      const i = Ee.focusableChildren(e);
      0 === i.length
        ? e.focus()
  ...
  class pn {
    ...
    _applyManipulationCallback(t, e) {
      if (zt(t)) e(t);
      else for (const i of Ee.find(t, this._element)) e(i);
    }
  }
  const mn = ".bs.modal",
    gn = `hide${mn}`,
  ...
  class $n extends we {
    ...
    show(t) {
      this._isShown ||
        ...
        me.trigger(this._element, vn, { relatedTarget: t }).defaultPrevented ||
        ((this._isShown = !0),
        (this._isTransitioning = !0),
    ...
    _addEventListeners() {
      me.on(this._element, Tn, (t) => {
        ...
        me.on(this._element, En, (t) => {
          me.one(this._element, An, (e) => {
  ...
  me.on(document, Cn, '[data-bs-toggle="modal"]', function (t) {
    ...
    i && $n.getInstance(i).hide(), $n.getOrCreateInstance(e).toggle(this);
  }),
    Te($n),
    Yt($n);
  ...
  class Xn extends we {
        ...
        this._queueCallback(
          () => {
            (this._config.scroll && !this._config.backdrop) ||
              ...
              me.trigger(this._element, zn, { relatedTarget: t });
          },
          this._element,
          !0
        ));
    ...
    hide() {
      this._isShown &&
        (me.trigger(this._element, Bn).defaultPrevented ||
          (this._focustrap.deactivate(),
          this._element.blur(),
          (this._isShown = !1),
          ...
          this._queueCallback(
            () => {
              this._element.classList.remove(Nn, jn),
                this._element.removeAttribute("aria-modal"),
                this._element.removeAttribute("role"),
    ...
    _addEventListeners() {
      me.on(this._element, Kn, (t) => {
        "Escape" === t.key &&
          (this._config.keyboard ? this.hide() : me.trigger(this._element, Wn));
      });
    }
    static jQueryInterface(t) {
      return this.each(function () {
  ...
  me.on(document, Vn, '[data-bs-toggle="offcanvas"]', function (t) {
    ...
    const i = Ee.findOne(Fn);
    i && i !== e && Xn.getInstance(i).hide(),
      Xn.getOrCreateInstance(e).toggle(this);
  }),
    me.on(window, Pn, () => {
      for (const t of Ee.find(Fn)) Xn.getOrCreateInstance(t).show();
    }),
    me.on(window, Rn, () => {
  ...
  class ms extends we {
    ...
    show() {
      ...
      if (
        (this._element.ownerDocument.documentElement.contains(this.tip) ||
          (n.append(i),
          me.trigger(this._element, this.constructor.eventName("inserted"))),
    ...
    _createTipElement(t) {
      ...
      return (
        e.setAttribute("id", i), this._isAnimated() && e.classList.add(os), e
      );
    }
    setContent(t) {
      (this._newContent = t),
    ...
    _isAnimated() {
      return (
        this._config.animation || (this.tip && this.tip.classList.contains(os))
      );
    }
    _isShown() {
      ...
      for (const e of t)
        if ("click" === e)
          ...
          me.on(this._element, t, this._config.selector, (t) => {
            ...
            (e._activeTrigger["focusin" === t.type ? us : hs] = !0), e._enter();
          }),
            me.on(this._element, i, this._config.selector, (t) => {
              const e = this._initializeOnDelegatedTarget(t);
              (e._activeTrigger["focusout" === t.type ? us : hs] =
    ...
    _configAfterMerge(t) {
      return (
        (t.container = !1 === t.container ? document.body : Bt(t.container)),
  ...
  class $s extends we {
    ...
    _maybeEnableSmoothScroll() {
      this._config.smoothScroll &&
        (me.off(this._config.target, Es),
        me.on(this._config.target, Es, Os, (t) => {
    ...
    _initializeTargetsAndObservables() {
      ...
      const t = Ee.find(Os, this._config.target);
      for (const e of t) {
    ...
    _activateParents(t) {
      if (t.classList.contains("dropdown-item"))
        Ee.findOne(".dropdown-toggle", t.closest(".dropdown")).classList.add(
          Cs
        );
      else
        for (const e of Ee.parents(t, ".nav, .list-group"))
          for (const t of Ee.prev(e, ks)) t.classList.add(Cs);
    }
    _clearActiveClass(t) {
      t.classList.remove(Cs);
      const e = Ee.find(`${Os}.${Cs}`, t);
  ...
  const Ds = ".bs.tab",
    ...
    Js = `.nav-link${Ys}, .list-group-item${Ys}, [role="tab"]${Ys}, ${Gs}`,
  ...
  class to extends we {
    constructor(t) {
      super(t),
        ...
        this._parent &&
          ...
          me.on(this._element, Fs, (t) => this._keydown(t)));
    }
    static get NAME() {
      return "tab";
    }
    show() {
      ...
      const e = this._getActiveElem(),
        i = e ? me.trigger(e, Is, { relatedTarget: t }) : null;
      me.trigger(t, Ns, { relatedTarget: e }).defaultPrevented ||
          ...
          () => {
            "tab" === t.getAttribute("role")
              ? (t.removeAttribute("tabindex"),
                ...
                me.trigger(t, Ms, { relatedTarget: e }))
              : t.classList.add(Qs);
          },
          t,
          t.classList.contains(Us)
        ));
    }
    _deactivate(t, e) {
      t &&
    ...
    _keydown(t) {
      if (![zs, Bs, Ws, qs, Rs, Vs].includes(t.key)) return;
      t.stopPropagation(), t.preventDefault();
      const e = this._getChildren().filter((t) => !qt(t));
      let i;
      if ([Rs, Vs].includes(t.key)) i = e[t.key === Rs ? 0 : e.length - 1];
      else {
        const n = [Bs, qs].includes(t.key);
        i = Zt(e, t.target, n, !0);
      }
      i && (i.focus({ preventScroll: !0 }), to.getOrCreateInstance(i).show());
    }
    _getChildren() {
      return Ee.find(Js, this._parent);
    }
    _getActiveElem() {
    ...
    _toggleDropDown(t, e) {
      ...
      const n = (t, n) => {
        const s = Ee.findOne(t, i);
        s && s.classList.toggle(n, e);
      };
      n(Xs, Ks), n(".dropdown-menu", Qs), i.setAttribute("aria-expanded", e);
    }
    ...
    _getInnerElement(t) {
      return t.matches(Js) ? t : Ee.findOne(Js, t);
    }
    _getOuterElement(t) {
  ...
  me.on(document, js, Gs, function (t) {
    ["A", "AREA"].includes(this.tagName) && t.preventDefault(),
      qt(this) || to.getOrCreateInstance(this).show();
  }),
    me.on(window, Hs, () => {
      for (const t of Ee.find(Zs)) to.getOrCreateInstance(t);
    }),
    Yt(to);
  const eo = ".bs.toast",
    io = `mouseover${eo}`,
  ...
  class go extends we {
    ...
    show() {
      me.trigger(this._element, lo).defaultPrevented ||
        (this._clearTimeout(),
    ...
    _setListeners() {
      me.on(this._element, io, (t) => this._onInteraction(t, !0)),
        me.on(this._element, no, (t) => this._onInteraction(t, !1)),
        me.on(this._element, so, (t) => this._onInteraction(t, !0)),
        me.on(this._element, oo, (t) => this._onInteraction(t, !1));
    }
    _clearTimeout() {
  ...
  [].slice
    ...
    [].slice
      ...
      .map(function (t) {
        ...
        const e = new go(t.getAttribute("data-bs-target"));
  ...
  const bo = "tblr-",
    vo = (t, e) => {
      ...
      return i
        ? `rgba(${parseInt(i[1], 16)}, ${parseInt(i[2], 16)}, ${parseInt(
            i[3],
            16
          )}, ${e})`
        : null;
